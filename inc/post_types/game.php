...
function register_post_types_game(){
    register_post_type( 'game', [
        ...
        'labels' => [
            ...
            'singular_name'      => 'games', // название для одной записи этого типа
            'add_new'            => 'Добавить игровой автомат', // для добавления новой записи
            'add_new_item'       => 'Добавление игрового автомата', // заголовка у вновь создаваемой записи в админ-панели.
            'edit_item'          => 'Редактирование игрового автомат', // для редактирования типа записи
            'new_item'           => 'Новый игровой автомат', // текст новой записи
