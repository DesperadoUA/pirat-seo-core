...
function game_taxonomy_register(){
    ...
    register_taxonomy('game_tax', array('game'), $args);
}
...
{
    $game_category_args = get_taxonomy('game_tax');
    $game_category_args->show_admin_column = true;
    $game_category_args->rewrite['slug'] = 'game-tax';
    $game_category_args->rewrite['with_front'] = false;
    register_taxonomy('game_tax', array('game'), (array)$game_category_args);
}
